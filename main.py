...
def process_sap_step(message):
    ...
    if sap_id in members_data:
        ...
        msg = bot.send_message(
            chat_id,
            "❌ ይቅርታ፣ ይህ የ SAP ID ቁጥር በቋታችን ላይ አልተገኘም። እባክዎን ትክክለኛውን የ SAP ID እንደገና ያስገቡ፦"
        )
        bot.register_next_step_handler(msg, process_sap_step)
